...
namespace TaurenEngine
{
	...
	public class Timer : PoolObject<Timer>
	{
		...
		public void Start()
		{
			...
			if (type == TimerType.Update || type == TimerType.UpdateInterval)
				TimerHelper.timerService.UpdateList.Add(this);
			else if (type == TimerType.LateUpdate || type == TimerType.LateUpdateInterval)
				TimerHelper.timerService.LateUpdateList.Add(this);
			else if (type == TimerType.FixedUpdate || type == TimerType.FixedUpdateInterval)
				TimerHelper.timerService.FixedUpdateList.Add(this);
			else
				Debug.LogError($"Timer类型异常：{type}");
		}
		...
		public void Stop()
		{
			...
			if (type == TimerType.Update || type == TimerType.UpdateInterval)
				TimerHelper.timerService.UpdateList.Remove(this);
			else if (type == TimerType.LateUpdate || type == TimerType.LateUpdateInterval)
				TimerHelper.timerService.LateUpdateList.Remove(this);
			else if (type == TimerType.FixedUpdate || type == TimerType.FixedUpdateInterval)
				TimerHelper.timerService.FixedUpdateList.Remove(this);
			else
				Debug.LogError($"Timer类型异常：{type}");
		}
