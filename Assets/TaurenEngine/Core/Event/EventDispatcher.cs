...
namespace TaurenEngine.Core
{
	public class EventDispatcher<T> : RefrenceObject, IRecycle
	{
		...
		/// 对象池
		/// </summary>
		internal readonly IObjectPool<EventList> eventListPool;

		/// <summary>
		/// 事件字典
		/// </summary>
		internal readonly Dictionary<T, EventList> events;
		/// <summary>
		/// 是否有注册的事件
		/// </summary>
		...
		{
			eventListPool = IPoolService.Instance.GetOrCreatePool<EventList>();
			events = new Dictionary<T, EventList>();
		}
