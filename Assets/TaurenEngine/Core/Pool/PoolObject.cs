...
namespace TaurenEngine.Core
{
	...
	public abstract class PoolObject<T> : LifecycleObject, IRecycle where T : PoolObject<T>, new()
	{
		#region 对象池静态函数
		private static IObjectPool<T> _pool;

		/// <summary>
		/// 获取对象池
		/// </summary>
		/// <returns></returns>
		public static IObjectPool<T> GetPool() => _pool ??= IPoolService.Instance.GetOrCreatePool<T>();
