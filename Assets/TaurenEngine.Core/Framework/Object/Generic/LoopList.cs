...
namespace TaurenEngine
{
	...
	public class LoopList<T> : DObject, IRecycle where T : IRefrenceObject
	{
		/// <summary>
		/// 循环状态
		/// </summary>
		...
		protected readonly RefrenceList<T> refrenceList = new RefrenceList<T>();
