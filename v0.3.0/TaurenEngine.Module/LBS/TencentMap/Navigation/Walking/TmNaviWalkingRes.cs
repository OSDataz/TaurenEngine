...
{
    public class TmNaviWalkingRes : TmNaviResponse
    {
        /// <summary>
        /// 搜索结果
        /// </summary>
        public TmNaviWalkingResResult result;
    ...
    public class TmNaviWalkingResResult
    {
        public List<TmNaviWalkingResRoute> routes;
    ...
    public class TmNaviWalkingResRoute
    {
        /// <summary>
        /// 方案交通方式，固定值：“WALKING”
        /// </summary>
        ...
        /// 路线步骤
        /// </summary>
        public List<TmNaviWalkingResStep> steps;
    ...
    public class TmNaviWalkingResStep
    {
        /// <summary>
        /// 阶段路线描述
        /// </summary>
        ...
        /// 阶段路线的步行设施类型（type）
        /// </summary>
        public TmNaviWalkingResRoadType type;
    }
}